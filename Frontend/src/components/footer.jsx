			...
			<div className="footer">
				...
				<div className="footer-right">
					...
					<div className="footer-in-box1">
						...
						<a href="tel:+918939933077">Phone: +91 89399 33077</a>
					</div>
					<div className="footer-in-box2">
						<img src={icons.icon12} alt="mail-icon" />
						<a href="mailto:innovationcenterrnaipl@outlook.com">
							innovationcenterrnaipl@outlook.com
						</a>
					</div>
				</div>
			</div>
			<p className="footer-text">
				&copy; 2024 RNAIPL . All rights reserverd.
			</p>
		</>
	);
}
