...
export default function Dashboard() {
    ...
    useEffect(() => {
        const fetchIdeaCount = async () => {
            try {
                const response = await axios.get("http://localhost:5001/api/analytics/idea");
        ...
        const fetchStatusCount = async () => {
            try {
                const response = await axios.get("http://localhost:5001/api/analytics/status");
                ...
                <div className="db-container">
                    ...
                    <div className="db-content">
                        ...
                        <div className="db-card">
                            ...
                            <button type="button" className="db-submit" onClick={()=>{
